...
export default function Assets() {
  ...
  const [form,setForm]=useState({title:'Sample',slug:'sample',playbackUrl:'https://example.com/hls.m3u8',type:'VOD'});
  ...
  return (
    <Layout>
      <h2>Assets</h2>
      <textarea rows={4} value={token} onChange={e=>setToken(e.target.value)} style={{width:'100%'}} />
